...
// ── Section: Economic Foundation (WITH ALL 4 PILLARS) ────────────────────────
const EconomicFoundationContent = () => (
  <div style={{ padding: "24px 32px", maxWidth: 1000 }}>
    ...
    <div style={{ display: "grid", gap: 20 }}>
      ...
      {/* 3. Overshooting - Precise Dornbusch Quote */}
      ...
      {/* 4. Efficient Market Hypothesis - Famous Fama Quotes */}
