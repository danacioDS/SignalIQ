...
export const useSignalAnalysis = (input: SignalData | number | null | undefined): RegimeAnalysis => {
  return useMemo(() => {
    console.log('📊 useSignalAnalysis - input:', input);
    ...
    } else if (input && typeof input === 'object' && 'ndi' in input) {
      signal = input as SignalData;
    }
